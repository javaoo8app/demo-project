<template>
  <div>
    ...
    <section
      ...
      id="aboutUs"
    >
      <h3 class="text-secondary font-weight-bold text-center mb-3">關於本站</h3>
      <h6 class="text-secondary text-center mb-5">Half of 73°C是一個公益平台，我們希望透過網站幫助台灣的弱勢族群，
        也致力於讓使用者有更方便且值得信賴的互助管道。</h6>
      <div class="row mb-4">
        <div class="col-md-6 mb-4">
          <div class="text-center">
            <img
              src="https://images.unsplash.com/photo-1476304884326-cd2c88572c5f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80"
            ...
            <div class="card">
              ...
              >
                <h2 class="mb-0">
                  ...
                  >
                    <i class="fas fa-lightbulb fa-2x  text-info ml-2"></i>
                    <span class="h6 ml-4 text-secondary font-weight-bold">發想起源</span>
                  </button>
                </h2>
              </div>
              ...
              >
                <h2 class="mb-0">
                  ...
                  >
                    ...
                    <span class="h6 ml-3 text-secondary font-weight-bold">我們的理念</span>
                  </button>
                </h2>
              </div>
              <div
              ...
              >
                <h2 class="mb-0">
                  ...
                  >
                    ...
                    <span class="h6 ml-4 text-secondary font-weight-bold">未來展望</span>
                  </button>
                </h2>
              </div>
              <div
